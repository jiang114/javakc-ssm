    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="ibox float-e-margins">
            <form id="searchForm" action="">
                <input id="order_id" name="order_id" type="hidden" value="${orderEntity.order_id}"/>
                <div class="col-sm-12">
                    <!-- ------------按钮组 start------------ -->
...
<%--                    </div>--%>
                    ...
                    <table class="table table-striped table-bordered table-hover table-condensed">
                        ...
                        <tr>
                            ...
                            <td class="col-sm-3"><fmt:formatDate value="${e.apply_date}" pattern="yyyy-MM-dd"/></td>
                    ...
                    <div  class="col-sm-12">
                        ...
                        <div>
                            ...
                            <tr>
                                ...
                                <td class="col-sm-3"><zhg:show value="${orderEntity.order_state}" codeTp="order_state"/></td>
                            </tr>
                            <tr>
                                <td class="col-sm-3">生产厂家名称：</td>
                                <td class="col-sm-3"> <input type="text" name="order_name" value="${orderEntity.order_name}"></td>
                                <td class="col-sm-3">生产厂家描述：</td>
                                <td class="col-sm-3"><input type="text" name="order_describe" value="${orderEntity.order_describe}"></td>
                            </tr>
                        </div>
                    </div>
                    </tbody>
...
<%--                </div>--%>
                    ...
                    <div class="modal-footer  btn-toolbar hidden-xs" role="group">
                        ...
                        <div class="col-sm-7">
                            <button type="button" class="btn btn-primary" id="tijiao" name="order/update.do">
